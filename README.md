...
После установки запустите `voice-input` из меню приложений или detached-командой:
...
можно закрыть. Лог фонового запуска пишется в
`~/.cache/voice-input/voice-input.log` и ротируется по 5 MiB, до 5 backup-файлов.
